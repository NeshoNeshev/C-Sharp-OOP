...
namespace Tests
{
    public class WarriorTests
    {
        ...
        //[Test]
        //public void Attack_Should_Decrease_Enemys_Hp_When_Damage_Equal_To_Enemys_Hp()
        //{
        //    Warrior myWarrior = new Warrior("Stiv", 100, 100);
        //    Warrior enemy = new Warrior("Peter", 40, 100);
        //    int expectedWarriorHp = myWarrior.HP - enemy.Damage;
        //    int expectedEnemyHp = enemy.HP-myWarrior.HP;

...
namespace Vehicles.Core
{
    public class Engine : IEngine
    {
        ...
        private Vehicle ProcessVehicleInfo()
        {
            ...
            double fuelCunsuption = double.Parse(vehicleArgs[2]);
            Vehicle cuurentVehicle = this.vehicleFactory.CreateVehicle(vehicleType, fuelQuantity, fuelCunsuption);
            return cuurentVehicle;
        }

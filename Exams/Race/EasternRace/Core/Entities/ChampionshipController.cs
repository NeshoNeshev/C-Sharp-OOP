...
namespace EasterRaces.Core.Entities
{
    ...
    {
        private const int PARTICIPATE_COUNT = 3;
        ...
        public string StartRace(string raceName)
        {
            ...
            if (race.Drivers.Count < PARTICIPATE_COUNT)
            {
                string exceptionMessage = string.Format(ExceptionMessages.RaceInvalid, raceName, PARTICIPATE_COUNT);
